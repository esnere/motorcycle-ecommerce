            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="privacy-content">
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">2. How We Use Your Information</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">3. Information Sharing and Disclosure</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">4. Cookies and Tracking Technologies</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">5. Data Security</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">6. Data Retention</h2>
                            ...
                            <p>Account information is retained until you request deletion or close your account.</p>
                        </section>

                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">7. Your Rights and Choices</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">8. Third-Party Links</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">9. Children's Privacy</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">10. International Data Transfers</h2>
                        ...
                        <section class="mb-5">
                            <h2 class="h4 text-success mb-3">11. Changes to This Privacy Policy</h2>
                            <p>We may update this privacy policy from time to time. We will notify you of any material changes by posting the new policy on this page and updating the "Last Updated" date. Your continued use of our services constitutes acceptance of any changes.</p>
                        </section>
